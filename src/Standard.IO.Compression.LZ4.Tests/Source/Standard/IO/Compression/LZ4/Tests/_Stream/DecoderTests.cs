...
namespace Standard.IO.Compression.LZ4.Tests
{
	...
	{
		[Theory]
		[InlineData("reymont", "-1 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("reymont", "-9 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("xml", "-1 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("xml", "-9 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("x-ray", "-1 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("x-ray", "-9 -BD -B4", LZ4MemoryHelper.K8)]
		...
		[Theory]
		[InlineData("reymont", "-1 -BD -B4 --content-size", LZ4MemoryHelper.K8)]
		[InlineData("xml", "-1 -BD -B4 --content-size", LZ4MemoryHelper.K8)]
		[InlineData("x-ray", "-1 -BD -B4 --content-size", LZ4MemoryHelper.K8)]
		...
		[InlineData("-9 -BD -B7", LZ4MemoryHelper.K8)]
		...
		[InlineData("-1 -BD -B7", LZ4MemoryHelper.K8)]
		[InlineData("-9 -BD -B4", LZ4MemoryHelper.K8)]
		[InlineData("-9 -BD -B5 -BX", LZ4MemoryHelper.K8)]
		[InlineData("-9 -BD -B6", LZ4MemoryHelper.K8)]
		[InlineData("-9 -BD -B7 -BX", LZ4MemoryHelper.K8)]
		[InlineData("-1 -B4", LZ4MemoryHelper.K8)]
		[InlineData("-1 -B7", LZ4MemoryHelper.K8)]
		[InlineData("-9 -B7 -BX", LZ4MemoryHelper.K8)]
