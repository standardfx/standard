...
namespace Standard.IO.Compression.LZ4.Tests
{
	public class BlockRoundtripTests
	{
		...
		public void BorderLineCompressions()
		{
			...
			var required = LZ4Codec.Encode(original, 0, original.Length, target, 0, target.Length, LZ4CompressionLevel.Level0);
			var minimal = LZ4Codec.Encode(original, 0, original.Length, target, 0, required, LZ4CompressionLevel.Level0);
