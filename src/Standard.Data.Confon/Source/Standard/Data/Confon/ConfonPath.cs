...
namespace Standard.Data.Confon
{
    //<#
    //  .SYNOPSIS
    //      Split a Confon path expression into its constituting parts.
    //
    //  .NOTES
    //      Confon path expressions are dot separated keys. However, if the key itself contains a dot, that key
