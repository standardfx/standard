...
{
    internal abstract class AbstractTokenizerQGramN : ITokenizer
    {
        ...
        protected AbstractTokenizerQGramN()
        {
        }
        ...
        public TokenizerUtility<string> TokenUtility
        {
            get
            {
                return this.tokenUtility;
            }
            set
            {
                this.tokenUtility = value;
            }
        }
    }
}
