...
{
    /// <summary>
    /// Utility class for working with memory related functions.
    /// </summary>
    internal unsafe class LZ4MemoryHelper
    {
        /// <summary>
        /// 1 KiB
        /// </summary>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint Peek32(void* p)
        {
            return *(uint*)p;
        }
        ...
        /// <param name="v">Value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Poke32(void* p, uint v)
        {
            *(uint*)p = v;
        }
