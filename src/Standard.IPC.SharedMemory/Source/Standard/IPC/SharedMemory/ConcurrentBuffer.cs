...
namespace Standard.IPC.SharedMemory
{
    ...
    public unsafe class ConcurrentBuffer : LockableBuffer
    {
        ...
        /// </summary>
        /// <param name="writeFunc">A function used to write to the buffer. The <see cref="IntPtr"/> parameter is a pointer to the buffer offset 
        /// by <paramref name="bufferPosition"/>.</param>
