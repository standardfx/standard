...
a {
   b {
     ...
     d = true
            ...
            var config = JPlusFactory.ParseString(confon).Root.GetObject().Unwrapped;
            var a = config["a"] as IDictionary<string, object>;
            var b = a["b"] as IDictionary<string, object>;
            Assert.Equal(1, (b["c"] as JPlusValue).GetInt32());
            Assert.True((b["d"] as JPlusValue).GetBoolean());
        }
        ...
        public void ThrowsParserExceptionOnUnterminatedObject() 
        {
            ...
            Assert.Throws<JPlusParserException>(() =>
                JPlusFactory.ParseString(confon));
        }
        ...
        {
            var confon = " array : [1,2,3]";
            Assert.Null(JPlusFactory.ParseString(confon).GetString("array"));
        }
        ...
        public void GettingArrayFromLiteralsReturnsNull() 
        {
            ...
            var res = JPlusFactory.ParseString(confon).GetStringList("literal");
        ...
        public void CanUsePathsAsKeys_3_14()
        {
            ...
            var confon2 = @"3 { 14 : 42}";
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("3.14"),
                JPlusFactory.ParseString(confon2).GetString("3.14"));
        }
        ...
        public void CanUsePathsAsKeys_3()
        {
            ...
            var confon2 = @"""3"" : 42";
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("3"),
                JPlusFactory.ParseString(confon2).GetString("3"));
        }
        ...
        public void CanUsePathsAsKeys_true()
        {
            ...
            var confon2 = @"""true"" : 42";
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("true"),
                JPlusFactory.ParseString(confon2).GetString("true"));
        }
        ...
        public void CanUsePathsAsKeys_FooBar()
        {
            ...
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("foo.bar"),
                JPlusFactory.ParseString(confon2).GetString("foo.bar"));
        }
        ...
        public void CanUsePathsAsKeys_FooBarBaz()
        {
            ...
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("foo.bar.baz"),
                JPlusFactory.ParseString(confon2).GetString("foo.bar.baz"));
        }
        ...
        public void CanUsePathsAsKeys_AX_AY()
        {
            ...
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("a.x"),
                JPlusFactory.ParseString(confon2).GetString("a.x"));
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("a.y"),
                JPlusFactory.ParseString(confon2).GetString("a.y"));
        }
        ...
        public void CanUsePathsAsKeys_A_B_C()
        {
            ...
            Assert.Equal(
                JPlusFactory.ParseString(confon1).GetString("a b c"),
                JPlusFactory.ParseString(confon2).GetString("a b c"));
        }
  ...
  c = Hello my name is ${a.name}
            ...
            Assert.Equal(
                ...
                JPlusFactory.ParseString(confon).GetString("a.c"));
        }
  ...
  c = ${a.b} [4,5,6]
            ...
            Assert.True(new[] {1, 2, 3, 4, 5, 6}.SequenceEqual(JPlusFactory.ParseString(confon).GetInt32List("a.c")));
        }
...
a {
   b {
     ...
     d = true
            ...
            var config = JPlusFactory.ParseString(confon);
...
";
            ...
            Assert.True(
                new[] {1, 2, 3, 4}.SequenceEqual(JPlusFactory.ParseString(confon).GetInt32List("root.array")));
            Assert.True(
                new[] {1, 2, 3, 4}.SequenceEqual(
                    JPlusFactory.ParseString(confon).GetInt32List("root.array-newline-element")));
            Assert.True(
                new[] {"1 2 3 4"}.SequenceEqual(
                    JPlusFactory.ParseString(confon).GetStringList("root.array-single-element")));
        }
...
";
            ...
            Assert.True(new[] {1, 2, 3}.SequenceEqual(JPlusFactory.ParseString(confon).GetInt32List("root.array")));
        }
...
";
            Assert.Equal("1", JPlusFactory.ParseString(confon).GetString("a.b"));
        }
        ...
        {
            var confon = "a= \t \t 1 \t \t,";
            Assert.Equal("1", JPlusFactory.ParseString(confon).GetString("a"));
        }
        ...
        {
            var confon = "a= \t \t 1 2 3 \t \t,";
            Assert.Equal("1 2 3", JPlusFactory.ParseString(confon).GetString("a"));
        }
        ...
        public void CanAssignIpAddressToField()
        {
            ...
            Assert.Equal("127.0.0.1", JPlusFactory.ParseString(confon).GetString("a"));
        }
        ...
        {
            var confon = @"""a""=1";
            Assert.Equal(1L, JPlusFactory.ParseString(confon).GetInt64("a"));
        }
        ...
        {
            var confon = @"a.b.c=1";
            Assert.Equal(1L, JPlusFactory.ParseString(confon).GetInt64("a.b.c"));
        }
...
[
    ...
    3
            ...
            Assert.True(new[] {1, 2, 3}.SequenceEqual(JPlusFactory.ParseString(confon).GetInt32List("a")));
        ...
        public void CanConcatenateArray()
        {
            ...
            Assert.True(new[] {1, 2, 3, 4}.SequenceEqual(JPlusFactory.ParseString(confon).GetInt32List("a")));
        }
    ...
    d = ${a.c}23
            ...
            Assert.Equal(1, JPlusFactory.ParseString(confon).GetInt32("a.c"));
            Assert.Equal(123, JPlusFactory.ParseString(confon).GetInt32("a.d"));
        }
        ...
        {
            var confon = @"a=1.1";
            Assert.Equal(1.1, JPlusFactory.ParseString(confon).GetDouble("a"));
        }
        ...
        {
            var confon = @"a=null";
            Assert.Null(JPlusFactory.ParseString(confon).GetString("a"));
        }
        ...
        {
            var confon = @"a=true";
            Assert.True(JPlusFactory.ParseString(confon).GetBoolean("a"));
            confon = @"a=false";
            Assert.False(JPlusFactory.ParseString(confon).GetBoolean("a"));
        ...
        {
            var confon = @"a=""hello""";
            Assert.Equal("hello", JPlusFactory.ParseString(confon).GetString("a"));
        }
...
foo {
   bar {
      ...
      c=3
            ...
            var config1 = JPlusFactory.ParseString(confon1);
            var config2 = JPlusFactory.ParseString(confon2);
...
foo {
   bar {
      borkbork=-1
            ...
            var config1 = JPlusFactory.ParseString(confon1);
            var config2 = JPlusFactory.ParseString(confon2);
            var config3 = JPlusFactory.ParseString(confon3);
            var config4 = JPlusFactory.ParseString(confon4);
...
";
  ...
  c {
     ...
     e = ${a.b}
            ...
            var ace = JPlusFactory.ParseString(confon).GetContext("a.c.e");
...
y = hello
";
            // mock the include function using the parser
            Func<string, JPlusRoot> include = s => JPlusParser.Parse(inclConfon, null);

            var config = JPlusFactory.ParseString(confon, include);
...
";
            ...
            Func<string, JPlusRoot> include2 = s => JPlusParser.Parse(inclConfon2, null);
            Func<string, JPlusRoot> include = s => JPlusParser.Parse(inclConfon, include2);
            var config = JPlusFactory.ParseString(confon, include);
