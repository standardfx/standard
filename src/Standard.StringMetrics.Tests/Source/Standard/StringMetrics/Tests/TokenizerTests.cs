...
namespace Standard.StringMetrics.Tests
{
    ...
    {
        internal TokenizerQGram3 TokenizerQGram3;
        internal TokenizerQGram3Extended TokenizerQGram3Extended;
        internal TokenizerQGram2 TokenizerQGram2;
        internal TokenizerSGram2 TokenizerSGram2;
        internal TokenizerQGram2Extended TokenizerQGram2Extended;
        internal TokenizerSGram2Extended TokenizerSGram2Extended;
