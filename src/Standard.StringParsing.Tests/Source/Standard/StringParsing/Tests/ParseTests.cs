...
using TRS = Standard.StringParsing.RS;
...
namespace Standard.StringParsing.Tests
{
    public class ParseTests
    {
        ...
        public void PositionedParser()
        {
            ...
            Assert.True(r.WasSuccessful);
            Assert.Equal(0, r.Value.Position.Value);
        ...
        public void RepeatExactlyParserErrorMessagesAreReadable()
        {
            ...
            var expectedMessage = string.Format(TRS.ParseFailureInfo, 
                string.Format(TRS.UnexpectedToken, TRS.EndOfInput),
                TRS.Expected + " " + string.Format(TRS.RepeatExactCountExpectation, "a", "4", "3"), 
                "Line 1, Column 1", 
                "");
