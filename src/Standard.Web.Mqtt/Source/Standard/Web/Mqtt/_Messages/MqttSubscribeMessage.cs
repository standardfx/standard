...
{
	/// <summary>
	/// Message from client to broker, requesting for subscription to the topics specified.
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>SUBSCRIBE</c> message specification.
	/// </remarks>
	public class MqttSubscribeMessage : MqttMessage
    {
        ...
        public MqttSubscribeMessage(string[] topics, byte[] qosLevels)
        {
            this.type = MQTT_MSG_SUBSCRIBE_TYPE;
        ...
        public static MqttSubscribeMessage Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            byte[] buffer;
            int index = 0;
            byte[] topicUtf8;
