...
{
	/// <summary>
	/// Message sent by client to broker for the purpose of publishing a message.
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>PUBLISH</c> message specification.
	/// </remarks>
	public class MqttPublishMessage : MqttMessage
	{
        ...
        public MqttPublishMessage(string topic, byte[] message) 
        ...
        public MqttPublishMessage(string topic, byte[] message, bool dupFlag, byte qosLevel, bool retain) 
			: base()
        {
            this.type = MQTT_MSG_PUBLISH_TYPE;
        ...
        public static MqttPublishMessage Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            byte[] buffer;
            int index = 0;
            byte[] topicUtf8;
