...
{
	/// <summary>
	/// Message sent from broker to client for the purpose of confirming that a connection has been established. 
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>CONNACK</c> message specification.
	/// </remarks>
	/// <seealso cref="MqttConnectMessage"/>
	public class MqttConnectAcknowledgeMessage : MqttMessage
    {
        #region Constants...
        ...
        /// Constructor
        /// </summary>
        public MqttConnectAcknowledgeMessage()
        {
        ...
        public static MqttConnectAcknowledgeMessage Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            byte[] buffer;
			MqttConnectAcknowledgeMessage msg = new MqttConnectAcknowledgeMessage();
