...
{
	/// <summary>
	/// Message sent by broker to client, indicating that a message that the client request to publish has been received. This is a QoS 1 flow.
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>PUBACK</c> message specification.
	/// </remarks>
	public class MqttPublishAcknowledgeMessage : MqttMessage
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public MqttPublishAcknowledgeMessage()
        {
