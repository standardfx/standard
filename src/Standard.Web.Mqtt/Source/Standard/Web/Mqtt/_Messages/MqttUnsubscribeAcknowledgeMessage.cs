...
{
	/// <summary>
	/// Message from broker to client, confirming that the client will be unsubscribing from the requested topics.
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>UNSUBACK</c> message specification.
	/// </remarks>
	public class MqttUnsubscribeAcknowledgeMessage : MqttMessage
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public MqttUnsubscribeAcknowledgeMessage()
        {
        ...
        public static MqttUnsubscribeAcknowledgeMessage Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            byte[] buffer;
            int index = 0;
            MqttUnsubscribeAcknowledgeMessage msg = new MqttUnsubscribeAcknowledgeMessage();
