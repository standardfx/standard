...
{
	/// <summary>
	/// The first part of a QoS 2 flow, representing that the message has been recorded by the broker.
	/// </summary>
	/// <remarks>
	/// This is an implementation of the <c>PUBREC</c> message specification.
	/// </remarks>
	public class MqttPublishRecordedMessage : MqttMessage
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public MqttPublishRecordedMessage()
        {
        ...
        public static MqttPublishRecordedMessage Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            byte[] buffer;
            int index = 0;
			MqttPublishRecordedMessage msg = new MqttPublishRecordedMessage();
